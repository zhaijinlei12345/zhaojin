...
<div class="MainForm BlogArticleManage">
  ...
  <ul>
      <?php foreach ($types as $type){?>
		<li class="row_1">
		<input name="blog" value="<?php echo $type->article_id ?>" type="checkbox">
		<a href="viewPost_comment.htm" target="_blank"><?php echo $type->title ?></a>
		<small><?php echo $type->post_date ?></small>
	</li>
      <?php }?>
	  </ul>
    <?php echo $links?>
