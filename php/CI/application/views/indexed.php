...
<div id="OSC_Banner">
	...
	<div id="portrait"><a href="User/adminIndex"><img src="assets/images/84.jpg" alt="Johnny" title="Johnny" class="SmallPortrait" user="154693" align="absmiddle"></a></div>
    <div id="lnks">
		<strong><?php if(isset($user)){echo $user->username;?>的博客
            <?php }else{?>
                未知人的博客
            <?php }?></strong>
		<div><a href="Welcome/indexed">TA的博客列表</a>&nbsp;|
...
<ul>
    <?php foreach ($list as $article){?>
        <li class='Blog' id='blog_24027'>
            ...
            <h2 class='BlogAccess_true BlogTop_0'><a href="Welcome/viewPost_comment?id=<?php echo $article->article_id ?>"><?php echo $article->title?></a></h2>
            ...
            <div class='TextContent' id='blog_content_24027'>
                ...
                <div class='fullcontent'><a href="Welcome/viewPost_comment?id=<?php echo $article->article_id ?>">阅读全文...</a></div>
...
<div class="BlogMenu"><div class="admin SpaceModule">
  ...
  <ul class="LinkLine">
	<li><a href="Welcome/newblog">发表博客</a></li>
			<li><a href="Welcome/blogCatalogs">博客分类管理</a></li>
	<li><a href="Welcome/blogs">文章管理</a></li>
	<li><a href="Welcome/blogComments">网友评论管理</a></li>
  </ul>
</div>
