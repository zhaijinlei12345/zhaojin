...
<div id="OSC_Banner">
    ...
    <div id="OSC_Channels">
        ...
        <li><a href="#" class="project">
                    心情here
<!--               <?php //if(isset($user)){echo $user->mood;} ?> -->
            </a></li>
        </ul>
    </div>
    <div class="clear"></div>
...
<!--          --><?php //}?>
	...
	<div id="portrait"><a href="adminIndex.htm"><img src="assets/images/84.jpg" alt="Johnny" title="Johnny" class="SmallPortrait" user="154693" align="absmiddle"></a></div>
    <div id="lnks">
		<strong>
<!--            --><?php //if(isset($user)){echo $user->username;?><!--的博客-->
<!--            --><?php //}else{?>
                未知人的博客
<!--            --><?php //}?>
             </strong>
