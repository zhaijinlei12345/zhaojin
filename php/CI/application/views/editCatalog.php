...
<table cellpadding="1" cellspacing="1">
    ...
    <?php foreach ($types as $type){?>
        <tr id="catalog_92334">
            <td class="idx"><?php echo  $type->type_id ?></td>
            <td class="name"><a href="Welcome/editCatalog" title="点击修改博客分类"><?php echo $type->type_name?></a></td>
            <td class="num"><?php echo $type->num ?></td>
            <td class="opts">
                <a href="Welcome/editCatalog" title="点击修改博客分类">修改</a>
